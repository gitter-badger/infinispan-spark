...
wget -P files/ -nc https://repo1.maven.org/maven2/org/infinispan/infinispan-remote/8.0.0.Beta1/infinispan-remote-8.0.0.Beta1.jar

files/spark-1.4.0-bin-hadoop2.6/bin/spark-shell --executor-memory=1g --master spark://$1:7077 --jars files/spark-streaming-twitter_2.10-1.4.0.jar,$(ls -m files/lib/*.jar | tr -d '\n'  | tr -d ' '),../../target/scala-2.10/infinispan-spark_2.10-0.1-SNAPSHOT-tests.jar,../../target/scala-2.10/infinispan-spark_2.10-0.1-SNAPSHOT.jar,files/infinispan-remote-8.0.0.Beta1.jar
